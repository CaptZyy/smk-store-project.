    ...
    <>
      ...
      <div className={`cart-sidebar ${isOpen ? "open" : ""}`}>
        <div className="cart-header">
          ...
          <button className="close-btn" onClick={handleCloseSidebar} style={{ height:"25px", width:"25px" }}>
            &times;
          </button>
        </div>
        ...
        >
          ...
          {view === "qr" && (
            <div style={{ textAlign: "center", marginTop: "20px" }}>
              <p style={{marginBottom:"20px"}}>Scan QRIS SMK Store:</p>
              <div
                style={{
                  background: "white",
                  padding: "15px",
        ...
        {view === "cart" && cartItems.length > 0 && (
          ...
          >
            ...
            <button
              ...
              style={{ width: "100%", height:"30px", borderRadius:"10px", borderStyle:"none" }}
              onClick={() => setView("qr")}
            >
              Bayar Sekarang
            </button>
